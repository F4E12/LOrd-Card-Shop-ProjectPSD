...
namespace ProjectPSD.Controller
{
    public class CustomerController
    {
        ...
        public static string ValidateRegisterForm(string username, string email, string password, string confirmPassword, string gender, DateTime dob)
        {
        ...
        public static string ValidateUserProfile(string username, string email, string password, string gender, DateTime dob)
        {
            if (string.IsNullOrEmpty(username) || string.IsNullOrEmpty(email) || string.IsNullOrEmpty(password) || string.IsNullOrEmpty(gender))
